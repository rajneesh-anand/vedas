...
const Widgets: React.FC<WidgetsProps> = ({ widgets }) => {
  ...
  return (
    <Container>
      <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 pb-[50px] pt-[50px]">
        {/* <WidgetAbout
          social={social}
        ...
        {widgets?.map((widget) => (
          <WidgetLink
            ...
            data={widget}
            className="pb-3.5 sm:pb-0 col-span-1 md:col-span-4 lg:pl-[64px]"
          />
        ))}
