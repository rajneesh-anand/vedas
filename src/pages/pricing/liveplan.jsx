...
const PricingLivePlanPage = ({ user }) => {
                      ...
                      {pricingData.map((item, index) => (
                        <tr key={index} height="88px">
                          ...
                          <td className="text-center bg-indigo-100">
                            {item.liveclass_monthly_status === 'active' ? (
                              <>
                                <button
                                  onClick={(e) =>
                                    handleClick(e, {
                          ...
                          <td className="text-center bg-yellow-100">
                            {item.liveclass_halfyearly_status === 'active' ? (
                              <>
                                <button
                                  onClick={(e) =>
                                    handleClick(e, {
                                      subject: item.name,
                                      plan: 'Half Yearly',
                                      amount: item.liveclass_halfyearly_fee,
                                    })
                                  }
                                  className="px-5 py-1.5  mt-4 w-[116px] border text-[18px] bg-gray-100 font-semibold rounded"
                                >
                                  &#x20B9; {item.liveclass_halfyearly_fee}
                                </button>
                          ...
                          <td className="text-center bg-green-100">
                            {item.liveclass_yearly_status === 'active' ? (
                              <>
                                <button
                                  onClick={(e) =>
                                    handleClick(e, {
                                      subject: item.name,
                                      plan: 'Yearly',
                                      amount: item.liveclass_yearly_fee,
                                    })
                                  }
                                  className="px-5 py-1.5 mt-4 w-[116px] border text-[18px] bg-gray-100 font-semibold rounded"
                                >
                                  &#x20B9; {item.liveclass_yearly_fee}
                                </button>
...
PricingLivePlanPage.Layout = Layout;

export default PricingLivePlanPage;
